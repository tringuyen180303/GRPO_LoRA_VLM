...
export TRANSFORMERS_CACHE=/N/slate/trihnguy/hf/transformers
export XDG_CACHE_HOME=/N/slate/trihnguy/cache
export TMPDIR=/N/slate/trihnguy/tmp
export HF_HUB_DISABLE_XET=1

mkdir -p "$HF_HOME" "$HF_HUB_CACHE" "$HF_DATASETS_CACHE" "$TRANSFORMERS_CACHE" "$XDG_CACHE_HOME" "$TMPDIR"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='verl_grpo_example_' \
